...
- (CGRect)frameOfPresentedViewInContainerView {
    ...
    presentedViewFrame.origin = CGPointMake((CGRectGetWidth(containerViewBounds) - CGRectGetWidth(presentedViewFrame)) / 2.0, (CGRectGetHeight(containerViewBounds) - CGRectGetHeight(presentedViewFrame)) / 4.0);
...
- (CGSize)sizeForChildContentContainer:(id<UIContentContainer>)container withParentContainerSize:(CGSize)parentSize {
    return CGSizeMake(parentSize.width * 0.9, parentSize.height * 0.5);
}
